...
-- =========================
INSERT INTO `users`
(`id`, `username`, `email`, `password`, `role`, `created_at`, `phone_number`, `avatar_url`)
VALUES
(
    1,
    'manager01',
...
-- =========================
INSERT INTO `pitches`
(`id`, `name`, `pitch_type`, `is_active`, `base_price`, `venue_id`)
VALUES
...
(`pitch_id`, `slot_number`, `is_weekend`, `price`)
VALUES
(1, 1, b'0', 350000.00),
(1, 1, b'1', 420000.00),
(2, 1, b'0', 500000.00),
...
VALUES
(2, 1, CURDATE(), '17:00:00', '18:30:00', 'RESERVED', 'MATCH', 500000.00, NOW()),
(2, 2, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '18:30:00', '20:00:00', 'RESERVED', 'TOUR', 900000.00, NOW()),
(2, 3, DATE_SUB(CURDATE(), INTERVAL 1 DAY), '14:00:00', '15:30:00', 'PLAYING', 'MATCH', 900000.00, NOW());

-- =========================
-- 7. REVIEWS
-- =========================
INSERT INTO `pitch_reviews`
(`pitch_id`, `player_id`, `rating`, `content`, `created_at`)
VALUES
